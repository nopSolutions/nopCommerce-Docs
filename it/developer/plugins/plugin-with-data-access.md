...
uid: it/developer/plugins/plugin-with-data-access
---
...
- [Developer tutorials](xref:it/developer/tutorials/index)
- [Updating an existing entity. How to add a new property.](xref:it/developer/tutorials/update-existing-entity)
- [How to write a plugin for nopCommerce 4.20](xref:it/developer/plugins/how-to-write-plugin-4.20)
