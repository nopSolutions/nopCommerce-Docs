...
uid: it/user-guide/getting-started
---
...
- [Configure general store settings](xref:it/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:it/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:it/user-guide/configuring/setting-up/shipping/index)
