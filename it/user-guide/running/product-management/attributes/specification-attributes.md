...
uid: it/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:it/user-guide/running/product-management/products/adding-products/index)
- [Product attributes](xref:it/user-guide/running/product-management/attributes/product-attributes)
