...
uid: it/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:it/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:it/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:it/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:it/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:it/user-guide/configuring/setting-up/payments/methods/paypal-standard)