...
sudo wget https://github.com/nopSolutions/nopCommerce/releases/download/release-4.80.3/nopCommerce_4.80.3_NoSource_linux_x64.zip

sudo apt-get install unzip

sudo unzip nopCommerce_4.80.3_NoSource_linux_x64.zip
```
