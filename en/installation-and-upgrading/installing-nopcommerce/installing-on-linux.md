...
sudo wget https://github.com/nopSolutions/nopCommerce/releases/download/release-4.90.6/nopCommerce_4.90.6_NoSource_linux_x64.zip

sudo apt-get install unzip

sudo unzip nopCommerce_4.90.6_NoSource_linux_x64.zip
```
