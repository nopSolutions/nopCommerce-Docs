...
sudo wget https://github.com/nopSolutions/nopCommerce/releases/download/release-4.90.0/nopCommerce_4.90.0_NoSource_linux_x64.zip

sudo apt-get install unzip

sudo unzip nopCommerce_4.90.0_NoSource_linux_x64.zip
```
