...
sudo wget https://github.com/nopSolutions/nopCommerce/releases/download/release-4.80.9/nopCommerce_4.80.9_NoSource_linux_x64.zip

sudo apt-get install unzip

sudo unzip nopCommerce_4.80.9_NoSource_linux_x64.zip
```
