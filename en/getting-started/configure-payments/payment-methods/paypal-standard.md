...
> [!Important]
>
> This plugin is currently deprecated and, starting from version 4.60, has been replaced by the [**PayPal Commerce**](xref:en/getting-started/configure-payments/payment-methods/paypal-commerce) plugin.
