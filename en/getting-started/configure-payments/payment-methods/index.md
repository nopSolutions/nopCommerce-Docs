...
To activate a payment method, click **Edit** beside the required method, tick the **Is active** checkbox, and click **Update**. The **Is active** option will change from *false* to *true*.
