...
- You can test this message template by clicking the **Test template** button. When clicked the *Send test email* is displayed, as follows: ![Send test email](_static/message-templates/test-template.jpg) Enter your email in the **Send email to** field, fill the tokens with some test values then click the **Send** button.
