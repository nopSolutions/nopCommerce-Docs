...
## "Install", "Uninstall" এবং "Update" মেথডগুলি পরিচালনা করা
...
1. **Install**. প্লাগইন ইনস্টলেশনের সময় এই মেথডটি চালু হয়। আপনি এখানে যেকোনো সেটিংস শুরু করতে পারেন, নতুন লোকাল রিসোর্স সন্নিবেশ করতে পারেন, অথবা কিছু নতুন ডাটাবেস টেবিল তৈরি করতে পারেন (প্রয়োজন হলে)।
1. **Uninstall**. প্লাগইন আনইনস্টল করার সময় এই মেথডটি চালু হয়।
1. **Update**. প্লাগইন আপডেটের সময় এই মেথডটি চালু করা হবে (যখন এর সংস্করণ `plugin.json` ফাইলে পরিবর্তিত হয়)।

> [!IMPORTANT]
> গুরুত্বপূর্ণ নোট: আপনি যদি এই মেথডগুলির মধ্যে একটিকে ওভাররাইড করেন তবে এর ভিত্তি বাস্তবায়ন গোপন করবেন না।
