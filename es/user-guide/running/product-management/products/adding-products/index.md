...
uid: es/user-guide/running/product-management/products/adding-products/index
---
...
- [Gift Card](xref:es/user-guide/marketing/promotional/gift-cards)
- [Downloadable Product](xref:es/user-guide/running/product-management/products/adding-products/downloadable-products)
- [Recurring Product](xref:es/user-guide/running/product-management/products/adding-products/recurring-products)
- [Rental Product](xref:es/user-guide/running/product-management/products/adding-products/rental-products)
...
- [Product categories](xref:es/user-guide/running/product-management/categories)
