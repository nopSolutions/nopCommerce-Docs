...
uid: es/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:es/user-guide/running/product-management/products/adding-products/index)
- [Product attributes](xref:es/user-guide/running/product-management/attributes/product-attributes)
