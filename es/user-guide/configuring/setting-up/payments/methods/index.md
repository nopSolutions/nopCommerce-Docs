...
uid: es/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:es/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:es/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:es/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:es/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:es/user-guide/configuring/setting-up/payments/methods/paypal-standard)