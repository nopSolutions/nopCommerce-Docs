...
uid: es/user-guide/configuring/setting-up/main-store/index
---
...
* [Setting up Multiple-Store](xref:es/user-guide/configuring/setting-up/main-store/multiple-store)
* [Countries](xref:es/user-guide/configuring/setting-up/main-store/countries)
* [Languages](xref:es/user-guide/configuring/setting-up/main-store/languages)
* [Security Settings](xref:es/user-guide/configuring/setting-up/main-store/security-settings)
* [PDF settings](xref:es/user-guide/configuring/setting-up/main-store/pdf-settings)
* [GDPR settings](xref:es/user-guide/configuring/setting-up/main-store/gdpr-settings)