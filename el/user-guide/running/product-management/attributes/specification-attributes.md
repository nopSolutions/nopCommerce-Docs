...
uid: el/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:el/user-guide/running/product-management/products/adding-products/index)
- [Product attributes](xref:el/user-guide/running/product-management/attributes/product-attributes)
