...
uid: el/user-guide/configuring/setting-up/main-store/index
---
...
* [Setting up Multiple-Store](xref:el/user-guide/configuring/setting-up/main-store/multiple-store)
* [Countries](xref:el/user-guide/configuring/setting-up/main-store/countries)
* [Languages](xref:el/user-guide/configuring/setting-up/main-store/languages)
* [Security Settings](xref:el/user-guide/configuring/setting-up/main-store/security-settings)
* [PDF settings](xref:el/user-guide/configuring/setting-up/main-store/pdf-settings)
* [GDPR settings](xref:el/user-guide/configuring/setting-up/main-store/gdpr-settings)