...
uid: el/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:el/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:el/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:el/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:el/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:el/user-guide/configuring/setting-up/payments/methods/paypal-standard)