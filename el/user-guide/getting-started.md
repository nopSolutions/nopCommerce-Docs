...
uid: el/user-guide/getting-started
---
...
- [Configure general store settings](xref:el/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:el/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:el/user-guide/configuring/setting-up/shipping/index)
