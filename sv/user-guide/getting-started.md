...
uid: sv/user-guide/getting-started
---
...
- [Configure general store settings](xref:sv/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:sv/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:sv/user-guide/configuring/setting-up/shipping/index)
