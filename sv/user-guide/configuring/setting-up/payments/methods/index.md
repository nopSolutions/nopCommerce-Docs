...
uid: sv/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:sv/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:sv/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:sv/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:sv/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:sv/user-guide/configuring/setting-up/payments/methods/paypal-standard)