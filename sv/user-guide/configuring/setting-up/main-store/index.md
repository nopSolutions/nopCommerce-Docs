...
uid: sv/user-guide/configuring/setting-up/main-store/index
---
...
* [Setting up Multiple-Store](xref:sv/user-guide/configuring/setting-up/main-store/multiple-store)
* [Countries](xref:sv/user-guide/configuring/setting-up/main-store/countries)
* [Languages](xref:sv/user-guide/configuring/setting-up/main-store/languages)
* [Security Settings](xref:sv/user-guide/configuring/setting-up/main-store/security-settings)
* [PDF settings](xref:sv/user-guide/configuring/setting-up/main-store/pdf-settings)
* [GDPR settings](xref:sv/user-guide/configuring/setting-up/main-store/gdpr-settings)