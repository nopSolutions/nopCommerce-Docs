...
uid: sv/user-guide/running/product-management/products/adding-products/index
---
...
- [Gift Card](xref:sv/user-guide/marketing/promotional/gift-cards)
- [Downloadable Product](xref:sv/user-guide/running/product-management/products/adding-products/downloadable-products)
- [Recurring Product](xref:sv/user-guide/running/product-management/products/adding-products/recurring-products)
- [Rental Product](xref:sv/user-guide/running/product-management/products/adding-products/rental-products)
