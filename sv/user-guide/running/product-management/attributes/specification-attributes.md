...
uid: sv/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:sv/user-guide/running/product-management/products/adding-products/index)
