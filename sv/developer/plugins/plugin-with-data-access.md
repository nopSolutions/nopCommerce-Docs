...
uid: sv/developer/plugins/plugin-with-data-access
---
...
- [Updating an existing entity. How to add a new property.](xref:sv/developer/tutorials/update-existing-entity)
- [How to write a plugin for nopCommerce 4.20](xref:sv/developer/plugins/how-to-write-plugin-4.20)
