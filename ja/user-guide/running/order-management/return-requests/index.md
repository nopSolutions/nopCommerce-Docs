...
uid: ja/user-guide/running/order-management/return-requests/index
---
...
* [Return request settings](xref:ja/user-guide/running/order-management/return-requests/return-requests-settings)
