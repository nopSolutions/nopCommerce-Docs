...
uid: ja/user-guide/running/order-management/orders/order-settings
---
...
* [Return request settings](xref:ja/user-guide/running/order-management/return-requests/index)
