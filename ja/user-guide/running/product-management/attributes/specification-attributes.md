...
uid: ja/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:ja/user-guide/running/product-management/products/adding-products/index)
