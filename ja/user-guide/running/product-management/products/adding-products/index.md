...
uid: ja/user-guide/running/product-management/products/adding-products/index
---
...
- [Gift Card](xref:ja/user-guide/marketing/promotional/gift-cards)
- [Downloadable Product](xref:ja/user-guide/running/product-management/products/adding-products/downloadable-products)
- [Recurring Product](xref:ja/user-guide/running/product-management/products/adding-products/recurring-products)
- [Rental Product](xref:ja/user-guide/running/product-management/products/adding-products/rental-products)
