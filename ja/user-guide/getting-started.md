...
uid: ja/user-guide/getting-started
---
...
- [Configure general store settings](xref:ja/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:ja/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:ja/user-guide/configuring/setting-up/shipping/index)
