...
uid: zh/user-guide/configuring/setting-up/main-store/index
---
...
* [Setting up Multiple-Store](xref:zh/user-guide/configuring/setting-up/main-store/multiple-store)
* [Countries](xref:zh/user-guide/configuring/setting-up/main-store/countries)
* [Languages](xref:zh/user-guide/configuring/setting-up/main-store/languages)
* [Security Settings](xref:zh/user-guide/configuring/setting-up/main-store/security-settings)
* [PDF settings](xref:zh/user-guide/configuring/setting-up/main-store/pdf-settings)
* [GDPR settings](xref:zh/user-guide/configuring/setting-up/main-store/gdpr-settings)