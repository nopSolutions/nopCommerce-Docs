...
uid: zh/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:zh/user-guide/running/product-management/products/adding-products/index)
- [Product attributes](xref:zh/user-guide/running/product-management/attributes/product-attributes)
