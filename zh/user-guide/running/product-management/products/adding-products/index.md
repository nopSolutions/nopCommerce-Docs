...
uid: zh/user-guide/running/product-management/products/adding-products/index
---
...
- [Gift Card](xref:zh/user-guide/marketing/promotional/gift-cards)
- [Downloadable Product](xref:zh/user-guide/running/product-management/products/adding-products/downloadable-products)
- [Recurring Product](xref:zh/user-guide/running/product-management/products/adding-products/recurring-products)
- [Rental Product](xref:zh/user-guide/running/product-management/products/adding-products/rental-products)
