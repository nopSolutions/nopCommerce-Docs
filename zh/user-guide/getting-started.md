...
uid: zh/user-guide/getting-started
---
...
- [Configure general store settings](xref:zh/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:zh/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:zh/user-guide/configuring/setting-up/shipping/index)
