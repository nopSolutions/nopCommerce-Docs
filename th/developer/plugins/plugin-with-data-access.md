...
uid: th/developer/plugins/plugin-with-data-access
---
...
- [Developer tutorials](xref:th/developer/tutorials/index)
- [Updating an existing entity. How to add a new property.](xref:th/developer/tutorials/update-existing-entity)
- [How to write a plugin for nopCommerce 4.20](xref:th/developer/plugins/how-to-write-plugin-4.20)
