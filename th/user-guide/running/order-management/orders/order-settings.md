...
uid: th/user-guide/running/order-management/orders/order-settings
---
...
* [Return request settings](xref:th/user-guide/running/order-management/return-requests/index)
