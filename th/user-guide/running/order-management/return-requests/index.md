...
uid: th/user-guide/running/order-management/return-requests/index
---
...
* [Return request settings](xref:th/user-guide/running/order-management/return-requests/return-requests-settings)
