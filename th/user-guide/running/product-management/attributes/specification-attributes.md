...
uid: th/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:th/user-guide/running/product-management/products/adding-products/index)
- [Product attributes](xref:th/user-guide/running/product-management/attributes/product-attributes)
