...
uid: th/user-guide/getting-started
---
...
- [Configure general store settings](xref:th/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:th/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:th/user-guide/configuring/setting-up/shipping/index)
