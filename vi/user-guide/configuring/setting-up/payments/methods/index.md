...
uid: vi/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:vi/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:vi/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:vi/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:vi/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:vi/user-guide/configuring/setting-up/payments/methods/paypal-standard)