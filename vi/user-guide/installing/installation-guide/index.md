...
uid: vi/user-guide/installing/installation-guide/index
---
...
- [Hosting providers](xref:vi/user-guide/installing/installation-guide/hosting-provider)
- [Installing Internet Information Services (IIS)](xref:vi/user-guide/installing/installation-guide/installing-IIS)
- [Known Issues and Solutions](xref:vi/user-guide/installing/installation-guide/known-issues-and-solutions)