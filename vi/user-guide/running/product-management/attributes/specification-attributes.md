...
uid: vi/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:vi/user-guide/running/product-management/products/adding-products/index)
