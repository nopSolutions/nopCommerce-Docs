...
uid: vi/user-guide/running/product-management/products/adding-products/index
---
...
- [Gift Card](xref:vi/user-guide/marketing/promotional/gift-cards)
- [Downloadable Product](xref:vi/user-guide/running/product-management/products/adding-products/downloadable-products)
- [Recurring Product](xref:vi/user-guide/running/product-management/products/adding-products/recurring-products)
- [Rental Product](xref:vi/user-guide/running/product-management/products/adding-products/rental-products)
...
- [Product categories](xref:vi/user-guide/running/product-management/categories)
