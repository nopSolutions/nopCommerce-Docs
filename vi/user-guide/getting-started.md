...
uid: vi/user-guide/getting-started
---
...
- [Configure general store settings](xref:vi/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:vi/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:vi/user-guide/configuring/setting-up/shipping/index)
