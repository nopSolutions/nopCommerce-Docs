...
uid: fa/developer/plugins/plugin-with-data-access
---
...
- [Developer tutorials](xref:fa/developer/tutorials/index)
- [Updating an existing entity. How to add a new property.](xref:fa/developer/tutorials/update-existing-entity)
- [How to write a plugin for nopCommerce 4.20](xref:fa/developer/plugins/how-to-write-plugin-4.20)
