...
uid: fa/user-guide/running/product-management/products/adding-products/index
---
...
- [Gift Card](xref:fa/user-guide/marketing/promotional/gift-cards)
- [Downloadable Product](xref:fa/user-guide/running/product-management/products/adding-products/downloadable-products)
- [Recurring Product](xref:fa/user-guide/running/product-management/products/adding-products/recurring-products)
- [Rental Product](xref:fa/user-guide/running/product-management/products/adding-products/rental-products)
