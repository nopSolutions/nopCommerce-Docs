...
uid: fa/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:fa/user-guide/running/product-management/products/adding-products/index)
- [Product attributes](xref:fa/user-guide/running/product-management/attributes/product-attributes)
