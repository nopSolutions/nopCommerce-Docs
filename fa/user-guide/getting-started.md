...
uid: fa/user-guide/getting-started
---
...
- [Configure general store settings](xref:fa/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:fa/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:fa/user-guide/configuring/setting-up/shipping/index)
