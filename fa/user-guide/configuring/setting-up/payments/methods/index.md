...
uid: fa/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:fa/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:fa/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:fa/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:fa/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:fa/user-guide/configuring/setting-up/payments/methods/paypal-standard)