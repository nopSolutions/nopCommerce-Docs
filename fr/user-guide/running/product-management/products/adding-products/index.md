...
uid: fr/user-guide/running/product-management/products/adding-products/index
---
...
- [Gift Card](xref:fr/user-guide/marketing/promotional/gift-cards)
- [Downloadable Product](xref:fr/user-guide/running/product-management/products/adding-products/downloadable-products)
- [Recurring Product](xref:fr/user-guide/running/product-management/products/adding-products/recurring-products)
- [Rental Product](xref:fr/user-guide/running/product-management/products/adding-products/rental-products)
...
- [Product categories](xref:fr/user-guide/running/product-management/categories)
