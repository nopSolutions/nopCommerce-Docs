...
uid: fr/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:fr/user-guide/running/product-management/products/adding-products/index)
