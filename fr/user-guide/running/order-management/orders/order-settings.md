...
uid: fr/user-guide/running/order-management/orders/order-settings
---
...
* [Return request settings](xref:fr/user-guide/running/order-management/return-requests/index)
