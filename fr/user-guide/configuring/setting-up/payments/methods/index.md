...
uid: fr/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:fr/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:fr/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:fr/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:fr/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:fr/user-guide/configuring/setting-up/payments/methods/paypal-standard)