...
uid: fr/user-guide/configuring/setting-up/main-store/index
---
...
* [Setting up Multiple-Store](xref:fr/user-guide/configuring/setting-up/main-store/multiple-store)
* [Countries](xref:fr/user-guide/configuring/setting-up/main-store/countries)
* [Languages](xref:fr/user-guide/configuring/setting-up/main-store/languages)
* [Security Settings](xref:fr/user-guide/configuring/setting-up/main-store/security-settings)
* [PDF settings](xref:fr/user-guide/configuring/setting-up/main-store/pdf-settings)
* [GDPR settings](xref:fr/user-guide/configuring/setting-up/main-store/gdpr-settings)