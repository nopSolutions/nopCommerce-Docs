...
uid: fr/user-guide/getting-started
---
...
- [Configure general store settings](xref:fr/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:fr/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:fr/user-guide/configuring/setting-up/shipping/index)
