...
uid: de/developer/plugins/plugin-with-data-access
---
...
- [Developer tutorials](xref:de/developer/tutorials/index)
- [Updating an existing entity. How to add a new property.](xref:de/developer/tutorials/update-existing-entity)
- [How to write a plugin for nopCommerce 4.20](xref:de/developer/plugins/how-to-write-plugin-4.20)
