...
uid: de/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:de/user-guide/running/product-management/products/adding-products/index)
- [Product attributes](xref:de/user-guide/running/product-management/attributes/product-attributes)
