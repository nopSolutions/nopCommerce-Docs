...
uid: de/user-guide/configuring/setting-up/main-store/index
---
...
* [Setting up Multiple-Store](xref:de/user-guide/configuring/setting-up/main-store/multiple-store)
* [Countries](xref:de/user-guide/configuring/setting-up/main-store/countries)
* [Languages](xref:de/user-guide/configuring/setting-up/main-store/languages)
* [Security Settings](xref:de/user-guide/configuring/setting-up/main-store/security-settings)
* [PDF settings](xref:de/user-guide/configuring/setting-up/main-store/pdf-settings)
* [GDPR settings](xref:de/user-guide/configuring/setting-up/main-store/gdpr-settings)