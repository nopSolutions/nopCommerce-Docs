...
uid: de/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:de/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:de/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:de/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:de/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:de/user-guide/configuring/setting-up/payments/methods/paypal-standard)