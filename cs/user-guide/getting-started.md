...
uid: cs/user-guide/getting-started
---
...
- [Configure general store settings](xref:cs/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:cs/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:cs/user-guide/configuring/setting-up/shipping/index)
