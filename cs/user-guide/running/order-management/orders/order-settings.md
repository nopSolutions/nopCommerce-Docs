...
uid: cs/user-guide/running/order-management/orders/order-settings
---
...
* [Return request settings](xref:cs/user-guide/running/order-management/return-requests/index)
