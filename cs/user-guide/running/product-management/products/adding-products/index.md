...
uid: cs/user-guide/running/product-management/products/adding-products/index
---
...
- [Gift Card](xref:cs/user-guide/marketing/promotional/gift-cards)
- [Downloadable Product](xref:cs/user-guide/running/product-management/products/adding-products/downloadable-products)
- [Recurring Product](xref:cs/user-guide/running/product-management/products/adding-products/recurring-products)
- [Rental Product](xref:cs/user-guide/running/product-management/products/adding-products/rental-products)
