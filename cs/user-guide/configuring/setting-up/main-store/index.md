...
uid: cs/user-guide/configuring/setting-up/main-store/index
---
...
* [Setting up Multiple-Store](xref:cs/user-guide/configuring/setting-up/main-store/multiple-store)
* [Countries](xref:cs/user-guide/configuring/setting-up/main-store/countries)
* [Languages](xref:cs/user-guide/configuring/setting-up/main-store/languages)
* [Security Settings](xref:cs/user-guide/configuring/setting-up/main-store/security-settings)
* [PDF settings](xref:cs/user-guide/configuring/setting-up/main-store/pdf-settings)
* [GDPR settings](xref:cs/user-guide/configuring/setting-up/main-store/gdpr-settings)