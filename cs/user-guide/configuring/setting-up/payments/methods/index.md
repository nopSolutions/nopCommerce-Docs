...
uid: cs/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:cs/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:cs/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:cs/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:cs/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:cs/user-guide/configuring/setting-up/payments/methods/paypal-standard)