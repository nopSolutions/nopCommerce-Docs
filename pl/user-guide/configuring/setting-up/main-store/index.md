...
uid: pl/user-guide/configuring/setting-up/main-store/index
---
...
* [Setting up Multiple-Store](xref:pl/user-guide/configuring/setting-up/main-store/multiple-store)
* [Countries](xref:pl/user-guide/configuring/setting-up/main-store/countries)
* [Languages](xref:pl/user-guide/configuring/setting-up/main-store/languages)
* [Security Settings](xref:pl/user-guide/configuring/setting-up/main-store/security-settings)
* [PDF settings](xref:pl/user-guide/configuring/setting-up/main-store/pdf-settings)
* [GDPR settings](xref:pl/user-guide/configuring/setting-up/main-store/gdpr-settings)