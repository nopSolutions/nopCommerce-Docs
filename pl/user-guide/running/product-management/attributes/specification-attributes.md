...
uid: pl/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:pl/user-guide/running/product-management/products/adding-products/index)
