...
uid: pl/user-guide/getting-started
---
...
- [Configure general store settings](xref:pl/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:pl/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:pl/user-guide/configuring/setting-up/shipping/index)
