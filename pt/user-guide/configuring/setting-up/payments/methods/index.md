...
uid: pt/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:pt/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:pt/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:pt/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:pt/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:pt/user-guide/configuring/setting-up/payments/methods/paypal-standard)