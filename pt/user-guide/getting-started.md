...
uid: pt/user-guide/getting-started
---
...
- [Configure general store settings](xref:pt/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:pt/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:pt/user-guide/configuring/setting-up/shipping/index)
