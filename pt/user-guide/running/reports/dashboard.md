---
title: Dashboard
uid: pt/user-guide/running/reports/dashboard
---
...
* [Orders](xref:pt/user-guide/running/order-management/orders/index)
* [Return requests](xref:pt/user-guide/running/order-management/return-requests/index)
* [Bestsellers](xref:pt/user-guide/running/reports/bestsellers-never-purchased)
* [Customers](xref:pt/user-guide/running/customer-management/index)
