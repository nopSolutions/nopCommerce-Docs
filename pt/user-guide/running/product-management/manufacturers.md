---
title: Manufacturers
uid: pt/user-guide/running/product-management/manufacturers
---
...
- [Adding products user](xref:pt/user-guide/running/product-management/products/adding-products/index)
