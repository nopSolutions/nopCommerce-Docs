...
uid: pt/user-guide/running/product-management/products/adding-products/index
---
...
- [Gift Card](xref:pt/user-guide/marketing/promotional/gift-cards)
- [Downloadable Product](xref:pt/user-guide/running/product-management/products/adding-products/downloadable-products)
- [Recurring Product](xref:pt/user-guide/running/product-management/products/adding-products/recurring-products)
- [Rental Product](xref:pt/user-guide/running/product-management/products/adding-products/rental-products)
