...
uid: da/user-guide/getting-started
---
...
- [Configure general store settings](xref:da/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:da/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:da/user-guide/configuring/setting-up/shipping/index)
