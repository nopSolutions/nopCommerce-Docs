...
uid: da/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:da/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:da/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:da/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:da/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:da/user-guide/configuring/setting-up/payments/methods/paypal-standard)