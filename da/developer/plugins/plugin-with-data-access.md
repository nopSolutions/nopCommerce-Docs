...
uid: da/developer/plugins/plugin-with-data-access
---
...
- [Developer tutorials](xref:da/developer/tutorials/index)
- [Updating an existing entity. How to add a new property.](xref:da/developer/tutorials/update-existing-entity)
- [How to write a plugin for nopCommerce 4.20](xref:da/developer/plugins/how-to-write-plugin-4.20)
