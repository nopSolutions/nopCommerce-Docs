...
uid: tr/user-guide/getting-started
---
...
- [Configure general store settings](xref:tr/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:tr/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:tr/user-guide/configuring/setting-up/shipping/index)
