...
uid: tr/user-guide/running/product-management/products/adding-products/index
---
...
- [Gift Card](xref:tr/user-guide/marketing/promotional/gift-cards)
- [Downloadable Product](xref:tr/user-guide/running/product-management/products/adding-products/downloadable-products)
- [Recurring Product](xref:tr/user-guide/running/product-management/products/adding-products/recurring-products)
- [Rental Product](xref:tr/user-guide/running/product-management/products/adding-products/rental-products)
