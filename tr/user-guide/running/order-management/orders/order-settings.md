...
uid: tr/user-guide/running/order-management/orders/order-settings
---
...
* [Return request settings](xref:tr/user-guide/running/order-management/return-requests/index)
