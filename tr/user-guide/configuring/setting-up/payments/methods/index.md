...
uid: tr/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:tr/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:tr/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:tr/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:tr/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:tr/user-guide/configuring/setting-up/payments/methods/paypal-standard)