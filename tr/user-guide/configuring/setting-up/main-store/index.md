...
uid: tr/user-guide/configuring/setting-up/main-store/index
---
...
* [Setting up Multiple-Store](xref:tr/user-guide/configuring/setting-up/main-store/multiple-store)
* [Countries](xref:tr/user-guide/configuring/setting-up/main-store/countries)
* [Languages](xref:tr/user-guide/configuring/setting-up/main-store/languages)
* [Security Settings](xref:tr/user-guide/configuring/setting-up/main-store/security-settings)
* [PDF settings](xref:tr/user-guide/configuring/setting-up/main-store/pdf-settings)
* [GDPR settings](xref:tr/user-guide/configuring/setting-up/main-store/gdpr-settings)