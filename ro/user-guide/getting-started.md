...
uid: ro/user-guide/getting-started
---
...
- [Configure general store settings](xref:ro/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:ro/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:ro/user-guide/configuring/setting-up/shipping/index)
