...
uid: ro/user-guide/running/product-management/attributes/specification-attributes
---
...
- [Adding new products](xref:ro/user-guide/running/product-management/products/adding-products/index)
- [Product attributes](xref:ro/user-guide/running/product-management/attributes/product-attributes)
