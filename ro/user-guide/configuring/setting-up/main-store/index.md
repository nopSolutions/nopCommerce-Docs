...
uid: ro/user-guide/configuring/setting-up/main-store/index
---
...
* [Setting up Multiple-Store](xref:ro/user-guide/configuring/setting-up/main-store/multiple-store)
* [Countries](xref:ro/user-guide/configuring/setting-up/main-store/countries)
* [Languages](xref:ro/user-guide/configuring/setting-up/main-store/languages)
* [Security Settings](xref:ro/user-guide/configuring/setting-up/main-store/security-settings)
* [PDF settings](xref:ro/user-guide/configuring/setting-up/main-store/pdf-settings)
* [GDPR settings](xref:ro/user-guide/configuring/setting-up/main-store/gdpr-settings)