...
uid: ro/user-guide/configuring/setting-up/shipping/providers/manual/index
---
...
* [Shipping Methods (Shipping by weight and by total)](xref:ro/user-guide/configuring/setting-up/shipping/providers/manual/methods)
* [Shipping Method Restrictions (shipping by weight and by total)](xref:ro/user-guide/configuring/setting-up/shipping/providers/manual/restrictions)
* [Shipping Methods (Fixed rate)](xref:ro/user-guide/configuring/setting-up/shipping/providers/manual/fixed-rate-methods)
* [Shipping Method Restrictions (Fixed rate)](xref:ro/user-guide/configuring/setting-up/shipping/providers/manual/fixed-rate-restrictions)