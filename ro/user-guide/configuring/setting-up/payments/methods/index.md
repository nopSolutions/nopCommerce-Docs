...
uid: ro/user-guide/configuring/setting-up/payments/methods/index
---
...
* [Square](xref:ro/user-guide/configuring/setting-up/payments/methods/square)
* [Qualpay](xref:ro/user-guide/configuring/setting-up/payments/methods/qualpay)
* [Manual Processing (Credit Card)](xref:ro/user-guide/configuring/setting-up/payments/methods/manual-processing)
* [Purchase order](xref:ro/user-guide/configuring/setting-up/payments/methods/purchase-order)
* [PayPal Standard](xref:ro/user-guide/configuring/setting-up/payments/methods/paypal-standard)