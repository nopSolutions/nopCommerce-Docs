...
* [Manual (Fixed or By Weight and By Total)](xref:ru/user-guide/configuring/setting-up/shipping/providers/manual/index)
* [UPS](xref:ru/user-guide/configuring/setting-up/shipping/providers/ups)