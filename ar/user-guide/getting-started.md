...
uid: ar/user-guide/getting-started
---
...
- [Configure general store settings](xref:ar/user-guide/configuring/setting-up/main-store/index)
- [Configure payment methods](xref:ar/user-guide/configuring/setting-up/payments/methods/index)
- [Configure shipping options](xref:ar/user-guide/configuring/setting-up/shipping/index)
