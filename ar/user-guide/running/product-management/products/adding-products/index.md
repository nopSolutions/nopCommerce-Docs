...
uid: ar/user-guide/running/product-management/products/adding-products/index
---
...
- [Gift Card](xref:ar/user-guide/marketing/promotional/gift-cards)
- [Downloadable Product](xref:ar/user-guide/running/product-management/products/adding-products/downloadable-products)
- [Recurring Product](xref:ar/user-guide/running/product-management/products/adding-products/recurring-products)
- [Rental Product](xref:ar/user-guide/running/product-management/products/adding-products/rental-products)
...
- [Product categories](xref:ar/user-guide/running/product-management/categories)
